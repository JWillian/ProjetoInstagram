      ...
      <div class="container" id="footer">
        <div class="row">
          <div class="col">
            ...
            <div class="col">
            <br>
            <p style="font-size:25px; color:white;" class="text-center" >Contato e Redes Sociais<p>
            
              <p id="fontfooter" style="padding: 0.5em;";>

              <div class="row" style="float:right;">
                <div class="col">
              <p style="color:white; float:right; font-size:19px;" id="fontfooter" ;>
              (12)98895-9102<br>
              3126-2963<br>        
              jonatasw40@gmail.com</a><br>
              </p>
              </div>
              <div class="col text-center">
              <a href="https://api.whatsapp.com/send?phone=5512988959102&text=Link%20Whats" 
              style="text-decoration:none; color:white;">
              <img src="img/Whats.png" width="28px"></a><br>        
              <img src="img/phone.png" width="28px"><br>
              <a href="https://mail.google.com/mail/u/0/#inbox" 
              style="text-decoration:none; color:white;">
              <img src="img/gmail.png" width="28px"></a><br><br><br></div>
          ...
          <div class="row text-center" id="fontfooter" style="color:white">
          <h5>TEC G.A | Todos os direitos reservados - @Desenvolvido por Jonatas Willian</h5>
        </div>
      </div>
    </footer>
  <!-- Fim da Footer  -->